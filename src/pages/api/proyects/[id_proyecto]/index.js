    ...
    switch (req.method) {
        ...
        case 'PUT':
            try {
                ...
                const [result] = await db.execute(`UPDATE proyectos SET ${proyecto.setString} WHERE id_proyecto = ${id_proyecto};`, [...proyecto.values]);
        ...
        case 'DELETE':
            try {
                ...
                await db.execute('DELETE FROM proyectos WHERE id_proyecto = ?', [id_proyecto]);
