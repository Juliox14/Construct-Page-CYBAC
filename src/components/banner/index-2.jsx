                    ...
                    <Col lg={{ span: 6 }}>
                        <div className={classes.with__sticker}>
                            <div className={classes.content}>
                                ...
                                Obten claridad, eficiencia y resultados sobresalientes,
                                enfócate en tu negocio mientras checamos los detalles.
                                Transforma tus ideas en realidades con nuestra gestión de proyectos de primer nivel.
                                </p>
