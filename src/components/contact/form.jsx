                ...
                >
                    ...
                    <div className={classes.form_asunto}>
                        ...
                        >
                            ...
                            <option value="Información de vacantes">
                                Preguntar por vacante
                            </option>
            ...
            {formError && (
                <div className={classes.error}>
                    <div role="alert">
                        ...
                        <span>
                            Error al enviar el formulario. Por favor, intentalo
                            más tarde.
                        </span>
                    </div>
                </div>
                ...
                <div className={classes.sended}>
                    <div className={classes.sended_container} role="alert">
                        <div className={classes.sended_content}>
                            ...
                            <div>
                                <p className={classes.sended_text}>
                                    ¡Gracias {formData?.nombre}! Tu mail ha sido
                                    recibido.
                                </p>
                                <p className={classes.sended_text2}>
