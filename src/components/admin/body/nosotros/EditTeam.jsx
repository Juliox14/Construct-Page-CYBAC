    ...
    return (
        <>
            ...
            <Box sx={{
                    ...
                    <form className={classes.homeEdit_teamSection_formSubservicio} ref={refForm} onSubmit={handleSubmit}>
                        <div>
                            <div>
                                <label htmlFor={`title_about_${data.titulo_equipo}`}>Título</label>
                                <textarea name="title_about" id={`title_about_${data.titulo_equipo}`} rows={10} cols={40} style={{resize: "none", backgroundColor: theme.palette.mode === 'dark' ? "#222F3E" : "white", color: theme.palette.mode === 'dark' ? "white" : "black", transition: `background-color ${theme.transitions.duration.standard}ms`}}
                                onChange={(e) => {
                            ...
                            <div>
                                ...
                                <textarea name="descripcion_about" id={`descripcion_about_${data.descripcion_equipo}`} rows={10} cols={40} style={{resize: "none", backgroundColor: theme.palette.mode === 'dark' ? "#222F3E" : "white", color: theme.palette.mode === 'dark' ? "white" : "black", transition: `background-color ${theme.transitions.duration.standard}ms`}}
                                onChange={(e) => {
                                    const updatedData = data;
                        ...
                        <div className={classes.homeEdit_teamSection_formSubservicio_updateAlert}>
