...
export default function MovilDropDown() {
    ...
    const navItems = ['Inicio', 'Nosotros', 'Servicios', 'Proyectos', 'Clientes', 'Contacto'];
    ...
    return (
        <>
            <Drawer
                ...
                sx={{
                    '& .MuiDrawer-paper': { boxSizing: 'border-box', width: drawerWidth, backgroundColor: '#014655' },
                }}
            >
                {drawer}
            </Drawer>
            ...
            >
            <MenuIcon sx={{fontSize: 30}} className={classes.movilHeaderElement_boxContainerOfNavAdmin_iconNav}/>
            </IconButton>
        </>
    )
}